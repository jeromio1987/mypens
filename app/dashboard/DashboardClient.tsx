...
import { ArrowLeft, TrendingDown, TrendingUp, Minus, Download, Scale, UtensilsCrossed, Moon, Dumbbell, Ruler } from 'lucide-react'
              ...
              {data.weight.latest ? (
                <div className="space-y-2">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-gray-400 text-sm">kg true</span>
